    ...
    return (
        <>
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center mt-12">
                <div className="w-96 text-gray-600 space-y-5 p-6 shadow-2xl border border-gray-200 rounded-2xl bg-white/95 backdrop-blur-sm">
                    ...
                    >
                        <div>
                            ...
                            <input
                                ...
                                className="w-full mt-2 px-3 py-2 text-gray-700 bg-white outline-none border border-gray-300 focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"
                            />
                        </div>
