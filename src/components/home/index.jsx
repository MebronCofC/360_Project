    ...
    return (
        <div className="max-w-7xl mx-auto p-6 mt-12">
            ...
            <section className="mb-12">
                <div className="bg-white/90 border border-gray-300 rounded-2xl p-5 shadow-sm" style={{ boxShadow: '0 10px 30px rgba(255,255,255,1), 0 2px 8px rgba(255,255,255,1)' }}>
